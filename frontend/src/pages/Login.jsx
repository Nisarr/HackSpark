    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 animate-in fade-in duration-700">
      <div className="w-full max-w-md">
        <div className="glass rounded-3xl p-8 md:p-10 border border-slate-200/50 dark:border-slate-700/50 shadow-2xl relative overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 -mb-20 -ml-20 w-40 h-40 bg-purple-500 rounded-full opacity-10 blur-3xl"></div>
          
          <div className="relative z-10">
            <div className="text-center mb-10">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-500 to-purple-600 text-white shadow-lg mb-6">
              ...
              <p className="text-slate-500 dark:text-slate-400">Sign in to your RentPi account to continue</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <a href="#" className="text-xs font-semibold text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">Forgot password?</a>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
            ...
            <div className="mt-8 flex items-center justify-center gap-4 text-slate-400">
              ...
              <span className="text-xs font-medium uppercase tracking-wider">New to RentPi?</span>
              <div className="h-px bg-slate-200 dark:bg-slate-800 flex-1"></div>
            </div>
